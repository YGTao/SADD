...
We apply for the following badges: **Functional**, **Reusable**, and **Available**.

**Functional:** The artifact includes complete implementations of all algorithms (SAddmin, SAProbDD, ddmin, ProbDD, WDD) in a self-contained Docker image, with all 62 benchmarks, experiment scripts, and pre-computed results that reproduce Tables 2–4 from the paper.
